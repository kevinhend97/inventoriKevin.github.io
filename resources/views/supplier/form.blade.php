			...
			<form class="form-horizontal" data-toggle="validator" method="post">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="noTelp" type="text" name="noTelp" autofocus="autofocus" placeholder="No. Telp" class="form-control" minlength="5" required="required" onkeypress="return hanyaAngka(event)">
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
