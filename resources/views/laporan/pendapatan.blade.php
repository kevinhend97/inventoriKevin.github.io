		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
        			...
        			<a href="{{$judul}}/pdf/{{$awal}}/{{$akhir}}" target="_blank" class="btn btn-info"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
				</div>
				<div class="box-body">
...
<script type="text/javascript">
  ...
  function periodeForm(){
    ...
    $('#jenis').val('Pendapatan');
    $('#formnya').attr({Action : "{{ route('laporan.refresh', $jenis = 'Pendapatan') }}"});
  }
</script>
@endsection